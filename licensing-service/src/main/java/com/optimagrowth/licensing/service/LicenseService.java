...
*/
    ...
    public License getLicense(String licenseId, String organizationId, String clientType) {
        ...
        if (license == null) {
            throw new IllegalArgumentException(String.format("license get with ids %s , %s error", licenseId, organizationId));
        }
    ...
    public String deleteLicense(String licenseId) {
        ...
        responseMessage = String.format("delete entity with id %s", licenseId);
